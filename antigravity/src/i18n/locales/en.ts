export const en: Record<string, string> = {
  ...
  'milestone.progress': '{n} more to the next reward!',
  ...
  'ctrl.pc.keyCross': 'Place <strong>✕ Mark</strong> (Hold & move to brush)',
  ...
  'ctrl.pc.tip': '💡 <strong>Pro Tips:</strong><br />• <strong>Hold X or M (or Gamepad A) while moving</strong> to continuously brush paint ✕ marks (undos in 1 step).<br />• You can navigate all menus and dialogs using Arrow keys or Tab, select with Enter/Space, and close with Esc.<br />• Even on cells with ✕ or ?, pressing Space directly places a Shiba 🐶 without penalty.',
  ...
  'ctrl.gamepad.btnADesc': 'Place / Remove <strong>✕ Mark</strong> (Hold & move to brush)',
  ...
  'set.bgm.name': '🎷 BGM (Smooth Jazz)',
  'set.bgm.desc': 'Play a mellow smooth-jazz backing track',
  'set.bgmvol.name': '🎚️ BGM Volume',
  'set.bgmvol.desc': 'Adjust how loud the music is',
