export const ja: Record<string, string> = {
  ...
  'ctrl.pc.keyCross': '<strong>✕ マーク</strong>を配置（長押ししながら移動で連続塗り）',
  ...
  'ctrl.pc.tip': '💡 <strong>お役立ちヒント:</strong><br />・<strong>X/Mキー（またはAボタン）を押しながら移動</strong>すると、連続で✕マークを一気に塗ることができます（アンドゥ1回でまとめて復元可能）。<br />・キーボード操作時、メニューやダイアログは矢印キー/Tabキーで選択、Enter/Spaceキーで決定、Escキーで閉じることができます。<br />・✕マークや？マークがあるマスでも、スペースキーで直接柴犬🐶を置けます。',
  ...
  'ctrl.gamepad.btnADesc': '<strong>✕ マーク</strong> を配置 / 削除（長押ししながら移動で連続塗り）',
  ...
  'set.bgm.name': '🎷 BGM (スムースジャズ)',
  'set.bgm.desc': 'ゆったりしたジャズ風のBGMを再生',
  'set.bgmvol.name': '🎚️ BGM音量',
  'set.bgmvol.desc': 'BGMの大きさを調整します',
